...
/**
 * Abstract base class for handling persistent headings across document containers.
 ...
 */
export abstract class PersistentHeadingsDocumentHandler extends DocumentHandler {
    /**
     ...
     */
    private applyLastHeadings(containers: Element[]) {
        containers.forEach(container => {
            const lastHeadingElements = container.querySelectorAll<HTMLElement>('.last-heading');
     ...
     */
    protected apply({sourceContainer, targetContainers}: { sourceContainer: Element, targetContainers: Element[] }) {
