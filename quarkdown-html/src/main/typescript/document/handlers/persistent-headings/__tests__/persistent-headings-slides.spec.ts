...
import {PersistentHeadingsSlides} from '../../../../document/handlers/persistent-headings/persistent-headings-slides';
...
describe('PersistentHeadingsSlides', () => {
  it('applies persistent headings to slides and backgrounds', async () => {
    ...
    const slide2H1 = slides[1].querySelector('[data-depth="1"]') as HTMLElement;
    const slide2H2 = slides[1].querySelector('[data-depth="2"]') as HTMLElement;
    expect(slide2H1.innerHTML).toBe('Title 1');
    expect(slide2H2.innerHTML).toBe('Title 2');

    const bg2H1 = backgrounds[1].querySelector('[data-depth="1"]') as HTMLElement;
    const bg2H2 = backgrounds[1].querySelector('[data-depth="2"]') as HTMLElement;
