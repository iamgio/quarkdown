...
- Il progetto è scritto in **Kotlin** (JVM) con Gradle

- L'esportazione avviene in HTML, CSS e JavaScript.

  - Le presentazioni sono gestite da [Reveal.js](https://revealjs.com)
  
  - Libri e articoli sono gestiti da [Paged.js](https://pagedjs.org)
...
> **`ParagraphToken`** `Un **paragrafo** con del testo. ![Immagine](img.url)`  
...
.row gap:{3cm}
    **Il parsing avviene ricorsivamente.**  
    ...
    !(_x550)[Ricorsione](img/recursion.svg)
...
Il software è ampiamente utilizzabile e copre buona parte dei possibili casi d'uso.

**Seppur ancora molto giovane, le potenzialità sono grandi.**  
È previsto il supporto a lungo termine, con nuove funzionalità, temi, wiki e tutorial.  
