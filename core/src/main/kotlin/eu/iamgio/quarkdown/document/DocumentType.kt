 ...
 * @param defaultNumberingFormat the default numbering format to apply if not overridden by the user
 */
enum class DocumentType(
    val preferredOrientation: PageOrientation,
    val defaultNumberingFormat: NumberingFormat? = null,
) {
    /**
     ...
     */
    PAGED(PageOrientation.PORTRAIT, NumberingFormat.fromString("1.1.1.1.1.1")),
