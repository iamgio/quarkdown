 ...
 */
open class LocalizationException(message: String) : PipelineException(message, RUNTIME_ERROR_EXIT_CODE)

/**
 * An exception thrown when a localization key is not found within a localization table.
 * @see LocalizationEntries
 */
class LocalizationKeyNotFoundException(tableName: String, locale: Locale, key: String) : LocalizationException(
 ...
 * @see LocalizationTable
 */
class LocalizationTableNotFoundException(tableName: String) : LocalizationException(
 ...
 * @see eu.iamgio.quarkdown.document.DocumentInfo.locale
 */
class LocaleNotSetException : LocalizationException(
