...
import com.quarkdown.core.media.fetch.DefaultRemoteMediaFetcher
...
private const val WORKING_DIR_PATH = "src/jvmTest/resources"
...
class MediaTest {
    ...
    fun `virtual local media exports as file reference artifact`() {
        ...
        val resource = media.accept(MediaOutputResourceConverter("icon.png", DefaultRemoteMediaFetcher))
    ...
    fun `disk local media exports as file reference artifact`() {
        ...
        val resource = media.accept(MediaOutputResourceConverter("icon", DefaultRemoteMediaFetcher))
        assertIs<FileReferenceOutputArtifact>(resource)
    }
