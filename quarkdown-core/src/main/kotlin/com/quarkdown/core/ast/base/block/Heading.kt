 ...
 *                                   even if it is not decorative. Useful for headings generated by functions
...
class Heading(
    ...
    /**
     * Decorative headings and ToC-excluded headings are not assigned a location and are not counted.
     */
    override val canTrackLocation: Boolean
        get() = !isDecorative && !excludeFromTableOfContents
