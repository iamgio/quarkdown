...
class QuarkdownModule(
    private val functions: Set<ExportableFunction>,
) : Set<ExportableFunction> by functions {
    /**
    ...
    operator fun plus(other: QuarkdownModule): QuarkdownModule = QuarkdownModule(functions + other)
}
