...
import com.quarkdown.core.pipeline.output.OutputResourceNaming
...
data class StoredMedia(
     ...
     */
    fun path(separator: String): String = OutputResourceNaming.stringToFileName(storage.name) + separator + name
