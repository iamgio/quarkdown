...
data class PersistentDirectedGraph<T>(
    ...
    override fun addVertex(value: T): PersistentDirectedGraph<T> = copy(vertices = vertices.adding(value))
    ...
    override fun addEdge(
        ...
        return copy(adjacency = adjacency.putting(from, currentNeighbors.adding(to)))
    }
    ...
    override fun addVertexAndEdge(
        ...
        return copy(
            vertices = vertices.adding(vertex),
            adjacency = adjacency.putting(edgeFrom, currentNeighbors.adding(edgeTo)),
        )
    }
}
