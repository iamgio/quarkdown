...
import com.quarkdown.stdlib.internal.parseCsvWithHeader
 ...
 * On platforms without a CSV parser, such as browsers, this function raises an error.
 *
...
fun csv(
    ...
    parseCsvWithHeader(file.readBytes()).forEach { row ->
