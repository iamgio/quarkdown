...
import com.quarkdown.quarkdoc.reader.json.readDocsIndexes
import java.io.File
...
/**
 * A [DocsIndexSource] that recursively discovers index files within a local [directory].
 * @param directory the root directory of the documentation
 */
data class DirectoryDocsIndexSource(
    private val directory: File,
) : DocsIndexSource {
    override fun readIndexes(): List<String> = readDocsIndexes(directory)
}
