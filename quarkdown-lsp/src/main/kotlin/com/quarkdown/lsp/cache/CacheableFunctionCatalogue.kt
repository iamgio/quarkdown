...
object CacheableFunctionCatalogue {
     ...
     *
     * Concurrent calls for the same directory only run the walk once: the lock keeps multiple
     * language server sessions starting in parallel from re-walking the docs N times.
