...
import com.quarkdown.core.util.concurrentMapOf
import com.quarkdown.core.util.withLock
...
object CacheableFunctionCatalogue {
    private val catalogue = concurrentMapOf<DocsIndexSource, Set<DocumentedFunction>>()
