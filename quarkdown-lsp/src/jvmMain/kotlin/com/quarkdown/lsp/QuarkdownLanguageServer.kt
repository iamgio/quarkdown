...
class QuarkdownLanguageServer(
    ...
    private val textDocumentService: TextDocumentService =
        QuarkdownTextDocumentService(
            this,
            executor,
            CompletionSuppliersFactory.default(docsIndexSourceOrThrow()),
            SemanticTokensSuppliersFactory.default(),
            HoverSuppliersFactory.default(docsIndexSourceOrThrow()),
            DiagnosticsSuppliersFactory.default(docsIndexSourceOrThrow()),
    ...
    val docsIndexSource: DocsIndexSource?
        get() = docsDirectory?.toFsEntry()?.let(::DirectoryDocsIndexSource)
