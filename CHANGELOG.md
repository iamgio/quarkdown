...
![Page number format](https://raw.githubusercontent.com/iamgio/quarkdown/main/docs/Page-counter/format.png)
...
#### [Get path to root directory](https://quarkdown.com/docs/quarkdown-stdlib/com.quarkdown.stdlib.module.Data/pathtoroot.html)
